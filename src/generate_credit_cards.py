...
def get_credit_card_crop_fit_rot(card_text: str, font_path: str, font_size=48, out_height=-1):
...
def get_credit_card_crop_fit(card_text: str, font_path: str, font_size=48, out_height=-1):
...
if __name__ == '__main__':
    generate_random_credit_cards(10)
